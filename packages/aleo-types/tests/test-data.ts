import { Record } from "../src/data";
import { Transaction } from "../src/transaction";


export const actualTxFromAPI: Transaction = {
    "type": "execute",
 ...
 export const exampleSquashRecord: Record = {
    owner: "aleo1reyw4qz706zf99386xrl3snlk4nd5vrn4qs4mp4sahg57r696sxsm7f6eg.private",
    kg: "29500000u64.private",
    last_water: "1746504287u64.private",
    level: "2u8.private",
    squash_name: "298272252769u128.private",
    squash_id: "3309240751u32.private",
    _nonce: "1843959197508278825462552272297884915336997536478936825259471072834086594166group.public",
};

export const exampleAuctionRecord: Record = {
    owner: "aleo1lx3g77tkhtjyv57qssnrz2paktw3fk607ct4c8jd8xcztqwm8vqq854h6z.private",
    bid: {
        amount: "1111111u64.private",
        auction_id: "4983474344475301755308058428332126043126071895793305770065726050946157265845field.private",
        bid_public_key: "3134065209017268198627636329335886684909863739317960554026212655040657919608group.private"
    },
    bid_id: "991668069680081932068044151272068362340972878432037192797604077621596503836field.private",
    _nonce: "3932435923512316916224603764148045960451043061329235325930221938608283812873group.public"
};
