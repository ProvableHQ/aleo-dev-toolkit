...
[`examples/react-app/src/components/functions/PrivateInputs.tsx`](https://github.com/ProvableHQ/aleo-dev-toolkit/blob/master/examples/react-app/src/components/functions/PrivateInputs.tsx)
and the provider wiring in [`examples/react-app/src/App.tsx`](https://github.com/ProvableHQ/aleo-dev-toolkit/blob/master/examples/react-app/src/App.tsx).
